# modified from http://code.activestate.com/recipes/578042-restricted-dictionary/
class RestrictedDict(dict):
    ...
    def __init__(self, allowed_keys, seq=(), ignore_warnings=False, **kwargs):
        """
    ...
    def __setitem__(self, key, value):
        ...
        if key in self._allowed_keys:
            ...
            if not self.ignore_warnings:
                print(f'Warning: Not storing {key}, it is not an allowed key.')

    def update(self, e=None, ignore_warnings=None,**kwargs):
        """
        Equivalent to dict.update(), but it was needed to call
        RestrictedDict.__setitem__() instead of dict.__setitem__
        """
        ignore_warnings_old = self.ignore_warnings
        ...
        self.ignore_warnings=ignore_warnings_old
