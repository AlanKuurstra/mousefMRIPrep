          ...
          do
            ...
            if [[ $N4CORRECT -eq 1 ]];
              then
                ...
                exe=" $exe $N4 -d ${DIM} -b [10] -c [50x50x40x30,0.00000001] -i ${IMAGESETARRAY[$l]} -o ${REPAIRED} -r 0 -s 2\n"
                pexe=" $pexe $N4 -d ${DIM} -b [10] -c [50x50x40x30,0.00000001] -i ${IMAGESETARRAY[$l]} -o ${REPAIRED} -r 0 -s 2  >> ${outdir}/job_${count}_metriclog.txt >> ${outdir}/job_${count}_metriclog.txt\n"
