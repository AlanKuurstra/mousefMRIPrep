...
if __name__=="__main__":
    ...
    if not skip_template:
        if overwrite_ants_work_dir and os.path.exists(ants_work_dir):
        ...
        *.nii*'
        ...
        template_newname = f'sub-{bids_datatype.capitalize()}Template_{template_basename}' + exts
    ...
    if not skip_probability_mask:
        ...
        probability_mask_new_name = f'sub-{bids_datatype.capitalize()}TemplateProbabilityMask_{template_basename}'+exts
        if not os.path.exists(os.path.join(derivatives_dir,derivatives_pipeline_name)):
            os.makedirs(os.path.join(derivatives_dir,derivatives_pipeline_name))
