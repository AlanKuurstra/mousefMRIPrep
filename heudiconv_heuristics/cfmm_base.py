...
def infotodict(seqinfo):
    ...
    info = {t1w_mprage: [],
            ...
            TOF_angio: [], DIS2D_TOF_SAG: [], DIS2D_TOF_COR: [], DIS2D_TOF_TRA: [], DIS2D_TOF_angio: [],
            DIS3D_TOF_angio: [],
            mag_echo_GRE: [],
            phase_echo_GRE: [],
            DIS2D_mag_echo_GRE: [],
    ...
    for idx, s in enumerate(seqinfo):
        ...
        if (
                'susc' in s.series_description or 'gre3d' in s.series_description or 't1_fl3d_p4_iso' in s.series_description):
            if ('M' in (s.image_type[2].strip())):
                if ('ND' in (s.image_type[3].strip())):
        ...
        # spc T2w
        if (
                'spc_T2' in s.series_description or 'T2w_SPC' in s.series_description or 'T2w_space' in s.series_description or 't2_space' in s.series_description or 't2_spc' in s.series_description or 'T2_spc' in s.series_description):
