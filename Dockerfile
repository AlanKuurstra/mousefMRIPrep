...
COPY . /code/
RUN chmod +x /code/bin/tar2bids.py
RUN chmod +x /code/bin/fix_mouse_bids.py
RUN chmod +x /code/bin/create_template.py
RUN chmod +x /code/bin/brain_extraction.py
RUN chmod +x /code/bin/brain_extraction_4d.py
RUN chmod +x /code/bin/downsample_atlas.py
